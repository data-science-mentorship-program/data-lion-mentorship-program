...
#### 样本案例：中文翻译A / B测试
##### *项目背景*
*A / B测试在网站优化中发挥重要作用。分析A / B测试数据是非常重要的数据科学家责任。特别是数据科学家必须确保结果可信赖，值得信赖，并得出结论。此外，公司经常在同一时间运行数十个甚至数百个A / B测试。手动分析所有这些都需要很多时间和人力。因此，通常的做法是查看典型的A / B测试分析步骤，并尝试尽可能自动化。这为数据科学家们提供了更多高层次话题的时间。在这个挑战中，您将从A / B测试中分析结果。此外，您将被要求设计一个自动化的算法。*
...
## 目前我们提供以下培训项目
### 六次课冲刺VIP一对一
适应人群：已经开始投简历，马上需要面试找工作，有一定基础，需要提高面试及实战技巧的学生。
...
### 十次金牌VIP一对一
适应人群：缺少data science项目经历，需要充实简历找工作，有志于从事数据科学行业的学生。
* 简历修改以及课程制定一次
* 基础知识 3-4 次
* 项目实战 3-5 次 
* 模拟面试 2-3 次
